...
function normalizeChild(row: DbRow) {
  ...
  return {
    ...
    medicalProvider: text(record.medicalProvider),
    medicalProviderPhone: text(record.medicalProviderPhone),
    dentistProvider: text(record.dentistProvider),
    dentistPhone: text(record.dentistPhone),
    insuranceProvider: text(record.insuranceProvider),
    insuranceMemberId: text(record.insuranceMemberId),
    emergencyContact1Name: text(record.emergencyContact1Name),
    emergencyContact1Phone: text(record.emergencyContact1Phone),
    emergencyContact1Relationship: text(record.emergencyContact1Relationship),
    emergencyContact2Name: text(record.emergencyContact2Name),
    emergencyContact2Phone: text(record.emergencyContact2Phone),
...
function safeChildRecord(child: DbRow, id: number) {
  ...
  return {
    ...
    medicalProvider: text(child.medicalProvider).slice(0, 200),
    medicalProviderPhone: text(child.medicalProviderPhone).slice(0, 50),
    dentistProvider: text(child.dentistProvider).slice(0, 200),
    dentistPhone: text(child.dentistPhone).slice(0, 50),
    insuranceProvider: text(child.insuranceProvider).slice(0, 200),
    insuranceMemberId: text(child.insuranceMemberId).slice(0, 120),
    emergencyContact1Name: text(child.emergencyContact1Name).slice(0, 160),
    emergencyContact1Phone: text(child.emergencyContact1Phone).slice(0, 50),
    emergencyContact1Relationship: text(child.emergencyContact1Relationship).slice(0, 100),
    emergencyContact2Name: text(child.emergencyContact2Name).slice(0, 160),
    emergencyContact2Phone: text(child.emergencyContact2Phone).slice(0, 50),
...
export async function GET(request: Request) {
  try {
    ...
    const sensitiveChildAccess = isOwner || isLicensee || ["children_basic", "transportation", "health_safety"].some((permission) => permissions.includes(permission));
