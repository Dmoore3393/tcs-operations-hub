...
const navItems = [
  ...
  { label: "Time Clock", href: "/time-clock", icon: CalendarClock },
  { label: "Time Off & Availability", href: "/time-off", icon: CalendarOff },
  ...
  { label: "Family Access & Privacy", href: "/family-access", icon: Lock },
  { label: "Family Communications", href: "/family-communications", icon: Megaphone },
  { label: "Children", href: "/children", icon: UserRound },
  { label: "Check-In / Out", href: "/attendance", icon: DoorOpen },
  { label: "Child File Audits", href: "/child-file-audits", icon: ClipboardCheck },
  { label: "Enrollment Readiness", href: "/enrollment-readiness", icon: Sparkles },
  { label: "Immunization Tracker", href: "/immunization-tracker", icon: Syringe },
  { label: "School Age Support", href: "/school-age-support", icon: BookOpen },
  { label: "Student Store", href: "/student-store", icon: Store },
  { label: "Team Store", href: "/team-store", icon: Store },
  { label: "Training Center", href: "/training-center", icon: BookOpen },
  ...
  { label: "CACFP Command Center", href: "/cacfp-command-center", icon: Utensils },
  { label: "Timesheets", href: "/timesheets", icon: FileText },
  { label: "Payroll Hours", href: "/payroll-ops", icon: CalendarClock },
  ...
  { label: "Billing & Subsidy", href: "/billing-command-center", icon: BadgeDollarSign },
  ...
  { label: "Licensing Inspection Mode", href: "/inspection-mode", icon: ClipboardCheck },
  { label: "Maintenance & Safety", href: "/maintenance", icon: Hammer },
...
const pageMeta: Record<string, { title: string; subtitle: string }> = {
  ...
  "/time-clock": { title: "Time Clock", subtitle: "Immutable clock-in, breaks, clock-out, and manager visibility" },
  "/time-off": { title: "Time Off & Availability", subtitle: "Requests, blocked dates, approvals, and attendance accountability rules" },
  "/my-schedule": { title: "My Schedule", subtitle: "Published shifts, location assignments, and schedule acknowledgement" },
  ...
  "/immunization-tracker": { title: "Immunization Tracker", subtitle: "California child-care and school shot records, conditional follow-up, and medical exemptions" },
  "/school-age-support": { title: "School Age Support Center", subtitle: "Homework, school contacts, IEP/504 supports, behavior plans, and review dates" },
  ...
  "/team-store": { title: "The Hub Team Store", subtitle: "Complete trainings, earn XP, and redeem staff rewards" },
  "/training-center": { title: "Training Center", subtitle: "Assigned trainings, certificate uploads, verification, renewals, and XP" },
  ...
  "/cacfp-command-center": { title: "CACFP Command Center", subtitle: "KidKare enrollment, menus, meal services, and claim-readiness review" },
  "/timesheets": { title: "Timesheets", subtitle: "Signatures, handoffs, completion, scanning, and department submission" },
  "/payroll-ops": { title: "Payroll Hours Dashboard", subtitle: "Scheduled versus actual hours, overtime risk, and payroll export" },
  ...
  "/billing-command-center": { title: "Billing & Subsidy Command Center", subtitle: "Family funding, subsidy timesheets, and transportation billing oversight" },
  ...
  "/compliance": { title: "Compliance Center", subtitle: "Cross-system child, emergency, immunization, form, and expiration readiness" },
  "/inspection-mode": { title: "Licensing Inspection Mode", subtitle: "Inspection-ready snapshot and direct links to secured source records" },
  "/maintenance": { title: "Maintenance & Safety", subtitle: "Facilities issues, safety priorities, assignments, and completion history" },
